    ...
    async function loadPersonalVisits(){
      ...
      try{
        ...
        try{
          ...
          // Fallback: use local mock data so dashboard shows something for debugging

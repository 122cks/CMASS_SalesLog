# list_sungdeok_tokens.py
# Print entries from kakao_entries.normalized.jsonl that contain '숭덕' and show key fields.
import json, re
p = 'kakao_entries.normalized.jsonl'
pat = re.compile(r'(\S*숭덕\S*)')
results = []
unique_tokens = set()
...
for i, r in enumerate(results, 1):
    print(f"[{i}] school: {r['school']} | neis_name: {r['neis_name']} | assigned_sales: {r['assigned_sales']}")
